...
/**
 * The persistent class for the screenplay_round_log database table.
 *
 */
@Entity
@Table(name = "screenplay_round_log")
@NamedQuery(name = "ScreenplayRoundLog.findAll",
		query = "SELECT s FROM ScreenplayRoundLog s")
public class ScreenplayRoundLog implements Serializable {
