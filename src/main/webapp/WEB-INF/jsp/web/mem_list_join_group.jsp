...
<script src="/resources/web/js/member_list_join_group.js"></script>
</head>
<body>
	...
	<div class="content">
		<div class="memberListCont" style="display: block;">
			<div class="contTop">
				<a href="javascript:;" id="removeDepart" class="btn">移入（0）</a>
				<!--
				-->
			...
			<div class="breadcrumb">
				<a href="/web/member_list?staffId=${staffId}">通讯录</a> > <span>移入成员</span>
			</div>
