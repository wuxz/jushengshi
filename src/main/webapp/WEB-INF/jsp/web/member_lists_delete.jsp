...
<script src="/resources/web/js/member_delete.js"></script>
</head>
<body>
	...
	<div class="content">
		<div class="memberListCont" style="display: block;">
			<div class="contTop">
				<a href="javascript:;" class="btn" id="deleteSelectedMemeber">删除（0）</a>
				<!--
				-->
				<a href="/web/member_list?staffId=${staffId}" class="btn btn-opa">取消</a>
				<!--
				-->
