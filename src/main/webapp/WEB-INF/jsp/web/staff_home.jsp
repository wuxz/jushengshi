...
<script src="/resources/web/js/screenplay.js"></script>
<script src="/resources/web/js/alertMemList.js"></script>
<script src="/resources/web/js/send_screenplay.js"></script>
<script src="/resources/web/js/jquery.cookie.js"></script>

<script src="/resources/web/js/new_guidance.js"></script>
<title>剧本 - 剧省事儿</title>
</head>
<body>
  ...
  <div class="circle" id=new_guidance></div>
	<div class="content">
		<div class="screenplayCont">
			<div class="contTop clearfix">
				...
				<span class="searchBox"> <input type="text" class="search"
					id="searchjubencontent" placeholder="搜索场景/角色"> <i
					class="searchBtn" id="searchScene"></i>
				</span>
			</div>		
			<div class="contTable">
				<div class="contTblHead">
					<%@include file="staff_header.jsp"%>
					<div class="selectBox" id="screenSelectTime">
						<div class="select" data="0">全部</div>
					...
					<div class="selectBox" id="screenSelectSide">
						<div class="select" data="0">全部</div>
						<i class="selectIcon"></i>
						<ul class="selectUl">
							<li data="0">全部</li>
					...
					<div class="selectBox" id="screenPlaySeason">
						<div class="select" data="0">全部场次</div>
						<i class="selectIcon"></i>
						<ul class="selectUl">
							<li data="0">全部场次</li>
							<li data="3">已拍摄</li>
